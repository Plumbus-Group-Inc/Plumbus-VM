...
TEST(Interpreter, Call) {
  ...
  std::vector<Instr> instrs{
      /* 0 */ Instr{.opType = eIMM,
                    .opID = eIMM_INTEGER,
                    .instrVar = InstrIMM::Builder().data(5).build()},
      /* 1 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(0).build()},
      /* 2 */
      Instr{.opType = eBINARY,
            .opID = eBINARY_EQUAL,
            .instrVar = InstrBINARY::Builder().regid1(0).regid2(0).ttypeid(kInt).build()},
      /* 3 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(1).build()},
      /* 4 */
      Instr{.opType = eBRANCH,
            .opID = eBRANCH_CALL,
      ...
      Instr{.opType = eIMM,
            .opID = eIMM_INTEGER,
            .instrVar = InstrIMM::Builder().data(0).build()},
      /* 8 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(1).build()},
      ...
      Instr{.opType = eBINARY,
            .opID = eBINARY_EQUAL,
            .instrVar = InstrBINARY::Builder().regid1(0).regid2(1).ttypeid(kInt).build()},
      /* 10 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(2).build()},
      /* 11 */
      Instr{.opType = eBRANCH,
            .opID = eBRANCH_BRANCH,
            .instrVar = InstrBRANCH::Builder().regid(2).offset(16).build()},

      // Wanna save R0 parameter value for future to R2
      /* 12 */
      Instr{.opType = eBINARY,
            .opID = eBINARY_ADD,
            .instrVar = InstrBINARY::Builder().ttypeid(kInt).regid1(0).regid2(1).build()},
      /* 13 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(2).build()},
      ...
      Instr{.opType = eIMM,
            .opID = eIMM_INTEGER,
            .instrVar = InstrIMM::Builder().data(-1).build()},
      /* 15 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(1).build()},
      ...
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(3).build()},
      /* 20 */
      Instr{.opType = eBRANCH,
            .opID = eBRANCH_CALL,
      ...
      Instr{.opType = eBINARY,
            .opID = eBINARY_ADD,
            .instrVar = InstrBINARY::Builder().ttypeid(kInt).regid1(0).regid2(2).build()},
      /* 23 */
      Instr{.opType = eREG,
            .opID = eREG_MOV,
            .instrVar = InstrREG::Builder().regid(0).build()},
